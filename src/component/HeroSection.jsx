          ...
          <Row>
            ...
            <Col md={10} >
              ...
              <div className="name">Mustofa Kamal</div>
                ...
                <p>
                  As a dedicated web developer at Raharja University, I, Mustofa Kamal, aged 21, have a great passion for developing my technical skills. With the knowledge I have gained through this study program, I have mastered various relevant
                  concepts and technologies in the IT world. I enjoy the continuous learning process and am always eager to explore related fields such as software development, network security, and data analysis. With my passion for learning, I am committed
                  to continuously improving myself and making a positive contribution to the world of web development.
                </p>
